...
def segment_image(
    ...
    # Save binary mask
    cv2.imwrite(
        os.path.join(output_dir, f"{base_name}_original_binary_mask.png"), 
...
if __name__ == "__main__":
    ...
    IMAGE_PATH = "D:/VCLab2/final_project/dataset/sat_pave_dataset/selection_org/test_029.png"
